<%@ Page Title="Document Upload" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="DocumentUpload.aspx.cs" Inherits="DocumentUpload" %>
       ...
       <div class="col-sm-4">
        <div class="form-horizontal">
            ...
            <div class="form-group" style="margin-top:-5px">
                    <label for="message" class="col-xs-4">Student's Document<label for="message" style="color:Red">*</label></label>
                    <div class="col-xs-8">
