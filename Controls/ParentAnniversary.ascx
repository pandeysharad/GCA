<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ParentAnniversary.ascx.cs" Inherits="Controls_ParentAnniversary" %>
    ...
    <div class="modal-dialog1">
        <div class="modal-content">
            ...
            <div class="modal-header View_header">
                <h4 class="modal-title">Today Parent Anniversary</h4>
            ...
            <div class="modal-body" id="Div2">
                   ...
                   <%-- <table width="100%">
                    ...
                    <asp:GridView ID="GridViewParentAnniversary" runat="server" AutoGenerateColumns="false" DataKeyNames="AdmissionId"
                        ...
                        <asp:BoundField DataField="ParentMobileNo" HeaderText="PARENT CONTACT" />
