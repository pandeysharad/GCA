        ...
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (install.Count<MonthlyInstallment>() > 0)
                {
                    ...
                    InstallString += "<tr style='font-weight:bold;'><td class='installr'></td><td class='installr'>Total</td><td class='installr'>" + (IClassFeesTotal).ToString("##,##,##,####.00") + "</td><td class='installr'>" + (ITransportFeesTotal).ToString("##,##,##,####.00") + "</td><td class='installr'>" + (IClassPaidTotal).ToString("##,##,##,####.00") + "</td><td class='installr'>" + (ITransportPaidTotal).ToString("##,##,##,####.00") + "</td><td class='installr'>" + (IClassBalTotal).ToString("##,##,##,####.00") + "</td><td class='installr'>" + (ITransportBalTotal).ToString("##,##,##,####.00") + "</td><td class='installr'></td></tr>";
                    InstallString += "</table>";
